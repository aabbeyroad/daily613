      ...
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-primary-600 rounded-2xl flex items-center justify-center mx-auto mb-4">
            <span className="text-3xl">Daily613</span>
          </div>
          <h1 className="text-2xl font-bold text-text-primary">데일리613 루틴트래커</h1>
          <p className="text-text-tertiary mt-1">맞벌이 육아인의 주체적인 일상</p>
        </div>
